...
public class BobbyMod implements ModInitializer {
    ...
    public void onInitialize() {
        this.toggleViewModel = KeyBindingHelper.registerKeyBinding(new ToggleKeyMapping(
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            EntityRendererPredicate.skipCustomRenderingInput = this.toggleViewModel.isDown();
        });
    }
